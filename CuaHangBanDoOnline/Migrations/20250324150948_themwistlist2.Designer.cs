...
namespace CuaHangBanDoOnline.Migrations
{
    ...
    [Migration("20250324150948_themwistlist2")]
    partial class themwistlist2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CuaHangBanDoOnline.Models.Wishlist", b =>
                {
                    ...
                    b.Property<int?>("WishlistMaWishlist")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CuaHangBanDoOnline.Models.Wishlist", b =>
                {
                    ...
                    b.HasOne("CuaHangBanDoOnline.Models.Wishlist", null)
                        .WithMany("Wishlists")
                        .HasForeignKey("WishlistMaWishlist");
